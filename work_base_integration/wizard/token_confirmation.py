...
class TokenConfirmation(models.TransientModel):
    ...
    host_id = fields.Many2one("work.base.integration", string="Host", domain=lambda self:[('allowed_user_ids', '=', self.env.user.id)])
    ...
    def action_confirm(self):
        ...
        self.employee_id.update_token(self.host_id, self.token)
