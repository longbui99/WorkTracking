...
class WorkWorkLog(models.Model):
    _name = "work.work.log"
    ...
    cluster_id = fields.Many2one('work.work.log.cluster', string='Cluster')
...
class WorkWorkLogCluster(models.Model):
    _name = "work.work.log.cluster"
