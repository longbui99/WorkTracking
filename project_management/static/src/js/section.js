...
odoo.define('project_management.section_widgets', function (require) {
    "use strict";
    ...
    var SectionAndNoteFieldText = function (parent, name, record, options) {
        var Constructor = FieldHtml;
        return new Constructor(parent, name, record, options);
    };

    fieldRegistry.add('section_and_note_one2many_html', SectionAndNoteFieldOne2Many);
    fieldRegistry.add('section_and_note_html', SectionAndNoteFieldText);
