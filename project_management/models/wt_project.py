...
class WtProject(models.Model):
    ...
    allowed_user_ids = fields.Many2many('res.users', 'res_user_wt_project_rel_1', 'project_id', 'user_id', string='Allowed Users')
    allowed_manager_ids = fields.Many2many('res.users', 'res_user_wt_project_rel_2', 'project_id', 'user_id', string='Managers')
